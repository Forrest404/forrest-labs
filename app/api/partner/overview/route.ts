...
export async function GET(request: NextRequest) {
  ...
  // Get org's teams first so we can find their dispatches
  const [
    { data: org },
    { data: teams },
    { data: resources },
  ...
  // Flatten to cluster objects, deduplicate by cluster_id
  ...
  // Map teams to use current_location field name expected by UI
