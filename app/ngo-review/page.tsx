    ...
    <div style={{ minHeight: '100vh', background: '#0d1117', color: '#e6edf3', fontFamily: 'system-ui, sans-serif', padding: '32px 24px' }}>
      <div style={{ maxWidth: 820, margin: '0 auto' }}>
        <div style={{ fontSize: 13, color: '#8b949e', marginBottom: 4 }}>
          NOUR — internal · <a href="/ngo-review/orgs" style={{ color: '#58a6ff', textDecoration: 'none' }}>Organisations</a> · <a href="/ngo-review/teams" style={{ color: '#58a6ff', textDecoration: 'none' }}>All teams</a>
        </div>
